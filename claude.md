...
- **Durée de session** : **3 minutes (180s)** — le clown doit avoir « chassé » (infecté) tous les enfants avant la fin du temps.
...
- Config actuelle : `MIN_PLAYERS = 2`, intermission 10 s, round Clown Survival 180 s (3 min).
